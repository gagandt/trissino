...
import { Instagram, Linkedin, Twitter, Facebook, BarChart, BarChart2, Clock, Eye, MessageCircle, Share2, ThumbsUp } from "lucide-react";
        ...
        <CardContent>
          <ScrollArea className="h-[600px] pr-4">
            {posts.map((post) => (
              <div
                key={post.id}
                className={`mb-4 cursor-pointer rounded-lg p-3 transition-all hover:shadow-md ${
