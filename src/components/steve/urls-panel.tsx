...
import { BrandItem, burgerLinks, skincareLinks } from '@/contants/brand-links'
import { PromptTypes } from '@/app/steve/page'
...
export default function SteveUrls(props: PropsTypes) {
  ...
  const addUrl = () => {
    setUrls([...urls, { name: `New Example ${urls.length + 1}`, url: 'https://acme.org', logo: '' }])
  }
