...
import { Loader2, Plus, Trash2, Edit2, SquareArrowOutUpRight } from 'lucide-react'
...
export default function SteveUrls(props: PropsTypes) {
    ...
    return (
        <div className="w-full max-w-3xl mt-12 flex flex-col items-center justify-center p-4">
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                                                    ...
                                                    <div className="flex-grow">
                                                        ...
                                                        {editingIndex === index ? (
                                                            ...
                                                            <div onClick={() => {
                                                                ...
                                                                <SquareArrowOutUpRight className='w-3.5' />
                                                            </div>
                                                        )}
                                                    </div>
